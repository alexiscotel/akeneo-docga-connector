...
namespace Oniti\Docga\ConnectorBundle\Elasticsearch\Filter\Attribute;
...
class ProductProposalDocgaFilter extends AbstractAttributeFilter implements AttributeFilterInterface
{
    /**
